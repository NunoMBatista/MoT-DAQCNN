...
Within a panel, line style encodes scale: dotted is the single-qubit
$\langle Z\rangle$-only source ($9$ features per patch), solid is the
single-kernel $\langle ZZ\rangle$ source ($45$), and dashed is the
four-kernel source ($180$); for the random family dotted/solid/dashed
are $9$/$45$/$180$ projections.
