...
# One end-to-end TissueMNIST analog HP search. MODEL via --export=ALL,MODEL=<name>
# selects configs/tissue_mnist/endtoend/<MODEL>.yml. 200G because the analog ZZ
# cache (~23 GB) is loaded; 64 G OOMs. Same budget as the digital rows
# (25 trials, 5 validation seeds).
cd ~/MoT-DAQCNN
mkdir -p logs
