...
base_cfg = {
    ...
    "model": {
        "from_scratch": True,        # False means use pretrained deit tiny pretrained
        "backbone": "deit_small_patch16_224",  # other available : DeiT-Small: "deit_small_patch16_224" #DeiT-Base: "deit_base_patch16_224"       
        "num_layers": 5,            
        "nhead": 4,                 
        "dim_feedforward": 128      
    },
    ...
    "wandb": {
        "project": "Quantum-ViT-scratch-5layers-400-epch"
    }
}
